...
class MainApplication:
    ...
    def log_in(self):
        ...
        value = db1.loginUser(self.user.get(), self.password.get())
        if value == "yes":
            self.password = ""
            ...
            if answer == "yes":
                db1.createUser(self.user.get(), self.password.get())
                self.password = ""
                self.passwordStorageWindow()
    ...
    def readNotes(self, event):
        ...
        notes = db1.readNotes(self.user.get(), name)
    ...
    def insertNewPassword(self):
        ...
        if self.newPasswordList.get().isspace() or self.newPasswordList.get() == "" or self.newNameList.get().isspace() or self.newNameList.get() == "":
            ...
            db1.insertPasswordData(self.user.get(), self.newNameList.get(), self.newPasswordList.get(), self.noteText.get("1.0", tk.END))
